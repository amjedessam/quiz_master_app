...
//   /// [T] is the type of question model to generate
//   /// [fromJson] is the function to convert JSON to the model
...
//     // Assuming the content is a JSON string, parse it
//     final questionsJson = content is String ? jsonDecode(content) : content;
//     return (questionsJson as List).map((q) => fromJson(q)).toList();
//   }
...
//     return Quiz(title: 'Quiz on $topic', questions: questions);
//   }

//   /// Analyze data (e.g., quiz results)
//   Future<DataAnalysis> analyzeData(Map<String, dynamic> data) async {
//     final prompt = '''
// Analyze the following data and provide a summary and key insights:
// ${data.toString()}

// Format as JSON with keys: summary, insights (object).
// ''';
...
//     final content = response.data['choices'][0]['message']['content'];
//     final analysisJson = content as Map<String, dynamic>;
