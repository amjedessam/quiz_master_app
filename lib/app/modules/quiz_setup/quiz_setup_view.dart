...
class QuizSetupView extends GetView<QuizSetupController> {
  ...
  Widget build(BuildContext context) {
    if (!showHistory) {
      return Scaffold(
        appBar: AppBar(title: const Text('إعداد الاختبار'), centerTitle: true),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                controller.selectedChapter.value!.name,
                                style: const TextStyle(
                                  fontSize: 14,
                      ...
                      children: [
                        ...
                        Obx(
                          () => Slider(
                            ...
                            onChanged: (v) {
                              controller.updateQuestionCount(v);
                            },
                          ),
                        ),
                      ],
  ...
  Widget _buildTypeCheckbox(String type, String label, IconData icon) {
    ...
    return Card(
      child: CheckboxListTile(
        value: isSelected,
        onChanged: (_) {
          controller.toggleQuestionType(type);
        },
        title: Row(
          children: [
            Icon(
